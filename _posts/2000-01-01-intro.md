...
style: left
---
# Weber State IEEE Club 2025-2026
{: .text-purple}
...
<div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px; margin-top: 20px;">
  ...
  <div style="text-align: center;">
    <img src="img/silvest.jpg" alt="Name 2" style="width: 200px; height: 200px; border-radius: 50%;">
    <p>Sarah Silvest<br>
    Executive VP</p>
  </div>
  <div style="text-align: center;">
    <img src="img/stettler.jpeg" alt="Name 3" style="width: 200px; height: 200px; border-radius: 50%;">
    <p>Nakoda Settler<br>
    VP of Outreach</p>
    </div>
    <div style="text-align: center;">
    <img src="img/appiah.jpeg" alt="appiah" style="width: 200px; height: 200px; border-radius: 50%;">
    <p>Michaela Appiah <br>
    VP of Marketing</p>
  </div>
</div>
