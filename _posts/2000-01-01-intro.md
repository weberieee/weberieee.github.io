...
<div style="display: flex; justify-content: center; flex-wrap: wrap; gap: 20px; margin-top: 20px;">
  ...
  <div style="text-align: center;">
    <img src="img/silvest.jpeg" alt="Name 2" style="width: 200px; height: 200px; border-radius: 50%;">
    <p>Sarah Silvest<br>
    Executive VP</p>
  </div>
  <div style="text-align: center;">
    <img src="img/settler.jpeg" alt="Name 3" style="width: 200px; height: 200px; border-radius: 50%;">
    <p>Nakoda Settler<br>
    VP of Outreach</p>
    </div>
    <div style="text-align: center;">
